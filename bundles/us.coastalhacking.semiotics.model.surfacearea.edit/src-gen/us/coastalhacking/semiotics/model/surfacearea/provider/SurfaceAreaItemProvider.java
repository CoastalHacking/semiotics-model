...
/**
 * This is the item provider adapter for a {@link us.coastalhacking.semiotics.model.surfacearea.SurfaceArea} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SurfaceAreaItemProvider 
	 ...
	 * @generated
	 */
	public SurfaceAreaItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addSurfaceAreaGroupPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Surface Area Group feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addSurfaceAreaGroupPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SurfaceArea_surfaceAreaGroup_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SurfaceArea_surfaceAreaGroup_feature", "_UI_SurfaceArea_type"),
				 SurfaceareaPackage.Literals.SURFACE_AREA__SURFACE_AREA_GROUP,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addControlsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SurfaceArea_controls_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SurfaceArea_controls_feature", "_UI_SurfaceArea_type"),
				 SurfaceareaPackage.Literals.SURFACE_AREA__CONTROLS,
				 true,
				 false,
				 true,
				 null,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SurfaceArea"));
	}
	...
	public String getText(Object object) {
		String label = ((SurfaceArea)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SurfaceArea_type") :
			getString("_UI_SurfaceArea_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SurfaceArea.class)) {
