 ...
 * </p>
 * <ul>
 *   <li>{@link us.coastalhacking.semiotics.model.control.impl.ControlGroupImpl#getName <em>Name</em>}</li>
 *   <li>{@link us.coastalhacking.semiotics.model.control.impl.ControlGroupImpl#getControls <em>Controls</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ControlGroupImpl extends MinimalEObjectImpl.Container implements ControlGroup {
	...
	protected EClass eStaticClass() {
		return ControlPackage.Literals.CONTROL_GROUP;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ControlPackage.CONTROL_GROUP__NAME, oldName, name));
	}
	...
	public EList<Control> getControls() {
		if (controls == null) {
			controls = new EObjectContainmentWithInverseEList<Control>(Control.class, this, ControlPackage.CONTROL_GROUP__CONTROLS, ControlPackage.CONTROL__CONTROL_GROUP);
		}
		return controls;
	}
