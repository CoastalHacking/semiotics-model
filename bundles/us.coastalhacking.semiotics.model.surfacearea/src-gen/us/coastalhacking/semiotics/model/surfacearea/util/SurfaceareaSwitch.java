 ...
 * @generated
 */
public class SurfaceareaSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SurfaceareaPackage.SURFACE_AREA_GROUP: {
				SurfaceAreaGroup surfaceAreaGroup = (SurfaceAreaGroup)theEObject;
				T result = caseSurfaceAreaGroup(surfaceAreaGroup);
				if (result == null) result = caseNameable(surfaceAreaGroup);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SurfaceareaPackage.SURFACE_AREA: {
				SurfaceArea surfaceArea = (SurfaceArea)theEObject;
				T result = caseSurfaceArea(surfaceArea);
				if (result == null) result = caseReviewable(surfaceArea);
	 ...
	 * @generated
	 */
	public T caseSurfaceAreaGroup(SurfaceAreaGroup object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseSurfaceArea(SurfaceArea object) {
		return null;
	}
