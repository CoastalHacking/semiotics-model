 ...
 * </p>
 * <ul>
 *   <li>{@link us.coastalhacking.semiotics.model.assessment.impl.DataFlowNodeImpl#getName <em>Name</em>}</li>
 *   <li>{@link us.coastalhacking.semiotics.model.assessment.impl.DataFlowNodeImpl#getEvidence <em>Evidence</em>}</li>
 *   <li>{@link us.coastalhacking.semiotics.model.assessment.impl.DataFlowNodeImpl#getExaminees <em>Examinees</em>}</li>
 *   <li>{@link us.coastalhacking.semiotics.model.assessment.impl.DataFlowNodeImpl#getFlowFrom <em>Flow From</em>}</li>
 *   <li>{@link us.coastalhacking.semiotics.model.assessment.impl.DataFlowNodeImpl#getFlowRoot <em>Flow Root</em>}</li>
 *   <li>{@link us.coastalhacking.semiotics.model.assessment.impl.DataFlowNodeImpl#getFlowTo <em>Flow To</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataFlowNodeImpl extends MinimalEObjectImpl.Container implements DataFlowNode {
	/**
	...
	protected EClass eStaticClass() {
		return AssessmentPackage.Literals.DATA_FLOW_NODE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssessmentPackage.DATA_FLOW_NODE__NAME, oldName, name));
	}
	...
	public EList<Provable> getEvidence() {
		if (evidence == null) {
			evidence = new EObjectWithInverseResolvingEList.ManyInverse<Provable>(Provable.class, this, AssessmentPackage.DATA_FLOW_NODE__EVIDENCE, AssessmentPackage.PROVABLE__TRACES);
		}
		return evidence;
	}
	...
	public EList<Examinable> getExaminees() {
		if (examinees == null) {
			examinees = new EObjectWithInverseResolvingEList.ManyInverse<Examinable>(Examinable.class, this, AssessmentPackage.DATA_FLOW_NODE__EXAMINEES, AssessmentPackage.EXAMINABLE__TRACES);
		}
		return examinees;
	}
	...
	public FlowNode<? extends FlowType> getFlowFrom() {
		if (eContainerFeatureID() != AssessmentPackage.DATA_FLOW_NODE__FLOW_FROM) return null;
	...
	public NotificationChain basicSetFlowFrom(FlowNode<? extends FlowType> newFlowFrom, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newFlowFrom, AssessmentPackage.DATA_FLOW_NODE__FLOW_FROM, msgs);
		return msgs;
	}
	...
	public void setFlowFrom(FlowNode<? extends FlowType> newFlowFrom) {
		if (newFlowFrom != eInternalContainer() || (eContainerFeatureID() != AssessmentPackage.DATA_FLOW_NODE__FLOW_FROM && newFlowFrom != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AssessmentPackage.DATA_FLOW_NODE__FLOW_FROM, newFlowFrom, newFlowFrom));
	}
	...
	public Flow<? extends FlowType> getFlowRoot() {
		if (eContainerFeatureID() != AssessmentPackage.DATA_FLOW_NODE__FLOW_ROOT) return null;
	...
	public NotificationChain basicSetFlowRoot(Flow<? extends FlowType> newFlowRoot, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newFlowRoot, AssessmentPackage.DATA_FLOW_NODE__FLOW_ROOT, msgs);
		return msgs;
	}
	...
	public void setFlowRoot(Flow<? extends FlowType> newFlowRoot) {
		if (newFlowRoot != eInternalContainer() || (eContainerFeatureID() != AssessmentPackage.DATA_FLOW_NODE__FLOW_ROOT && newFlowRoot != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AssessmentPackage.DATA_FLOW_NODE__FLOW_ROOT, newFlowRoot, newFlowRoot));
	}
	...
	public EList<FlowNode<? extends FlowType>> getFlowTo() {
		if (flowTo == null) {
			flowTo = new EObjectContainmentWithInverseEList<FlowNode<? extends FlowType>>(FlowNode.class, this, AssessmentPackage.DATA_FLOW_NODE__FLOW_TO, AssessmentPackage.FLOW_NODE__FLOW_FROM);
		}
		return flowTo;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AssessmentPackage.DATA_FLOW_NODE__NAME:
				return getName();
			case AssessmentPackage.DATA_FLOW_NODE__EVIDENCE:
				return getEvidence();
			case AssessmentPackage.DATA_FLOW_NODE__EXAMINEES:
