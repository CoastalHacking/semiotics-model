 ...
 * </p>
 * <ul>
 *   <li>{@link us.coastalhacking.semiotics.model.assessment.impl.DataFlowSourceImpl#getFlowGroup <em>Flow Group</em>}</li>
 *   <li>{@link us.coastalhacking.semiotics.model.assessment.impl.DataFlowSourceImpl#getValue <em>Value</em>}</li>
 *   <li>{@link us.coastalhacking.semiotics.model.assessment.impl.DataFlowSourceImpl#getSourceType <em>Source Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataFlowSourceImpl extends DataFlowImpl implements DataFlowSource {
	...
	protected EClass eStaticClass() {
		return AssessmentPackage.Literals.DATA_FLOW_SOURCE;
	}
	...
	public FlowGroup getFlowGroup() {
		if (eContainerFeatureID() != AssessmentPackage.DATA_FLOW_SOURCE__FLOW_GROUP) return null;
	...
	public NotificationChain basicSetFlowGroup(FlowGroup newFlowGroup, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newFlowGroup, AssessmentPackage.DATA_FLOW_SOURCE__FLOW_GROUP, msgs);
		return msgs;
	}
	...
	public void setFlowGroup(FlowGroup newFlowGroup) {
		if (newFlowGroup != eInternalContainer() || (eContainerFeatureID() != AssessmentPackage.DATA_FLOW_SOURCE__FLOW_GROUP && newFlowGroup != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AssessmentPackage.DATA_FLOW_SOURCE__FLOW_GROUP, newFlowGroup, newFlowGroup));
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssessmentPackage.DATA_FLOW_SOURCE__VALUE, oldValue, value));
	}
	...
	public void setSourceType(DataSourceType newSourceType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssessmentPackage.DATA_FLOW_SOURCE__SOURCE_TYPE, oldSourceType, sourceType));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AssessmentPackage.DATA_FLOW_SOURCE__FLOW_GROUP:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case AssessmentPackage.DATA_FLOW_SOURCE__VALUE:
				return getValue();
			case AssessmentPackage.DATA_FLOW_SOURCE__SOURCE_TYPE:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == FlowSource.class) {
			switch (derivedFeatureID) {
				case AssessmentPackage.DATA_FLOW_SOURCE__FLOW_GROUP: return AssessmentPackage.FLOW_SOURCE__FLOW_GROUP;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == FlowSource.class) {
			switch (baseFeatureID) {
				case AssessmentPackage.FLOW_SOURCE__FLOW_GROUP: return AssessmentPackage.DATA_FLOW_SOURCE__FLOW_GROUP;
				default: return -1;
			}
		}
