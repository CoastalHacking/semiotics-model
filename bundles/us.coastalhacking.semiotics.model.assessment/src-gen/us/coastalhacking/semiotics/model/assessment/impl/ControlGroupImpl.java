 ...
 * </p>
 * <ul>
 *   <li>{@link us.coastalhacking.semiotics.model.assessment.impl.ControlGroupImpl#getName <em>Name</em>}</li>
 *   <li>{@link us.coastalhacking.semiotics.model.assessment.impl.ControlGroupImpl#getControls <em>Controls</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ControlGroupImpl extends MinimalEObjectImpl.Container implements ControlGroup {
	...
	protected EClass eStaticClass() {
		return AssessmentPackage.Literals.CONTROL_GROUP;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssessmentPackage.CONTROL_GROUP__NAME, oldName, name));
	}
	...
	public EList<Control> getControls() {
		if (controls == null) {
			controls = new EObjectContainmentWithInverseEList<Control>(Control.class, this, AssessmentPackage.CONTROL_GROUP__CONTROLS, AssessmentPackage.CONTROL__CONTROL_GROUP);
		}
		return controls;
	}
