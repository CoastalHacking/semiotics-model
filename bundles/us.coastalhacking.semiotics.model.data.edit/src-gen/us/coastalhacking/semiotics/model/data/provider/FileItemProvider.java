...
import us.coastalhacking.semiotics.model.data.File;

/**
 * This is the item provider adapter for a {@link us.coastalhacking.semiotics.model.data.File} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FileItemProvider extends DataItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_File_fullPath_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_File_fullPath_feature", "_UI_File_type"),
				 DataPackage.Literals.FILE__FULL_PATH,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(File.class)) {
			case DataPackage.FILE__FULL_PATH:
