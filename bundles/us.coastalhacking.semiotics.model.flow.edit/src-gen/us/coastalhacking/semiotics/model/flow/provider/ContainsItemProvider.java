...
/**
 * This is the item provider adapter for a {@link us.coastalhacking.semiotics.model.flow.Contains} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ContainsItemProvider extends DataFlowConstraintItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Contains_contents_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Contains_contents_feature", "_UI_Contains_type"),
				 FlowPackage.Literals.CONTAINS__CONTENTS,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Contains)object).getName();
