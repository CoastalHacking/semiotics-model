...
/**
 * This is the item provider adapter for a {@link us.coastalhacking.semiotics.model.flow.ControlFlow} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ControlFlowItemProvider extends FlowItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ControlFlow_description_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ControlFlow_description_feature", "_UI_ControlFlow_type"),
				 FlowPackage.Literals.CONTROL_FLOW__DESCRIPTION,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ControlFlow.class)) {
			case FlowPackage.CONTROL_FLOW__DESCRIPTION:
