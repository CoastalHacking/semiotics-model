...
/**
 * This is the item provider adapter for a {@link us.coastalhacking.semiotics.model.assessment.NetworkIngress} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NetworkIngressItemProvider 
	 ...
	 * @generated
	 */
	public NetworkIngressItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns NetworkIngress.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/NetworkIngress"));
	}
	...
	public String getText(Object object) {
		String label = ((NetworkIngress)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_NetworkIngress_type") :
			getString("_UI_NetworkIngress_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(NetworkIngress.class)) {
