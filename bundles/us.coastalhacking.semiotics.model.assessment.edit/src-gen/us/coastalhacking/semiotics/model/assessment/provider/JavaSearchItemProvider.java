...
/**
 * This is the item provider adapter for a {@link us.coastalhacking.semiotics.model.assessment.JavaSearch} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class JavaSearchItemProvider 
	 ...
	 * @generated
	 */
	public JavaSearchItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addExamineesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Searchable_examinees_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Searchable_examinees_feature", "_UI_Searchable_type"),
				 AssessmentPackage.Literals.SEARCHABLE__EXAMINEES,
				 true,
				 false,
				 true,
				 null,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/JavaSearch"));
	}
	...
	public String getText(Object object) {
		String label = ((JavaSearch)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_JavaSearch_type") :
			getString("_UI_JavaSearch_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(JavaSearch.class)) {
