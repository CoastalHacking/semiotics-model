	...
	protected void addContentsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_File_contents_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_File_contents_feature", "_UI_File_type"),
				 AssessmentPackage.Literals.FILE__CONTENTS,
				 true,
				 true,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
