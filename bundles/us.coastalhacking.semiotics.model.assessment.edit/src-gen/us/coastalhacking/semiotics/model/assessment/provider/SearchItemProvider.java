...
/**
 * This is the item provider adapter for a {@link us.coastalhacking.semiotics.model.assessment.Search} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SearchItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addSearchGroupPropertyDescriptor(object);
		}
	...
	protected void addReviewersPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Searchable_reviewers_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Searchable_reviewers_feature", "_UI_Searchable_type"),
				 AssessmentPackage.Literals.SEARCHABLE__REVIEWERS,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Search Group feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addSearchGroupPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Search_searchGroup_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Search_searchGroup_feature", "_UI_Search_type"),
				 AssessmentPackage.Literals.SEARCH__SEARCH_GROUP,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AssessmentPackage.Literals.SEARCH__PATTERN);
		}
	...
	public String getText(Object object) {
		String label = ((Search)object).getName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AssessmentPackage.Literals.SEARCH__PATTERN,
				 AssessmentFactory.eINSTANCE.createJavaSearchPattern()));
	}
