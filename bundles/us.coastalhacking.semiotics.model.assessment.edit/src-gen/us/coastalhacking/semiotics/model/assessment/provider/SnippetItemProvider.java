...
/**
 * This is the item provider adapter for a {@link us.coastalhacking.semiotics.model.assessment.Snippet} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addReviewersPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Provable_reviewers_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Provable_reviewers_feature", "_UI_Provable_type"),
				 AssessmentPackage.Literals.PROVABLE__REVIEWERS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTracesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Provable_traces_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Provable_traces_feature", "_UI_Provable_type"),
				 AssessmentPackage.Literals.PROVABLE__TRACES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addDataPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Snippet_data_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Snippet_data_feature", "_UI_Snippet_type"),
				 AssessmentPackage.Literals.SNIPPET__DATA,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addRowPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Snippet_row_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Snippet_row_feature", "_UI_Snippet_type"),
				 AssessmentPackage.Literals.SNIPPET__ROW,
				 true,
				 false,
				 false,
	...
	protected void addColumnPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Snippet_column_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Snippet_column_feature", "_UI_Snippet_type"),
				 AssessmentPackage.Literals.SNIPPET__COLUMN,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addLengthPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Snippet_length_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Snippet_length_feature", "_UI_Snippet_type"),
				 AssessmentPackage.Literals.SNIPPET__LENGTH,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
