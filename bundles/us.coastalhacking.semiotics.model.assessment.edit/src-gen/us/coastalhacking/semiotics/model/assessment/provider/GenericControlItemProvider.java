...
/**
 * This is the item provider adapter for a {@link us.coastalhacking.semiotics.model.assessment.GenericControl} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GenericControlItemProvider 
	 ...
	 * @generated
	 */
	public GenericControlItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns GenericControl.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/GenericControl"));
	}
	...
	public String getText(Object object) {
		String label = ((GenericControl)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_GenericControl_type") :
			getString("_UI_GenericControl_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(GenericControl.class)) {
