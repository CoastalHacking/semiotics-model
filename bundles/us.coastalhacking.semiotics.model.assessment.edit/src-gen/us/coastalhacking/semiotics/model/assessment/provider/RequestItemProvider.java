...
/**
 * This is the item provider adapter for a {@link us.coastalhacking.semiotics.model.assessment.Request} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addResponsePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Request_response_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Request_response_feature", "_UI_Request_type"),
				 AssessmentPackage.Literals.REQUEST__RESPONSE,
				 true,
				 false,
				 true,
				 null,
