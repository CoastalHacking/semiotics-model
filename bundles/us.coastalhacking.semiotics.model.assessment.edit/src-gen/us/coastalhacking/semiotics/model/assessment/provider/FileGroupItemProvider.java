...
/**
 * This is the item provider adapter for a {@link us.coastalhacking.semiotics.model.assessment.FileGroup} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FileGroupItemProvider 
	 ...
	 * @generated
	 */
	public FileGroupItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/FileGroup"));
	}
	...
	public String getText(Object object) {
		String label = ((FileGroup)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_FileGroup_type") :
			getString("_UI_FileGroup_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(FileGroup.class)) {
