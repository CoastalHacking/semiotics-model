...
/**
 * This is the item provider adapter for a {@link us.coastalhacking.semiotics.model.assessment.ApplicationAssessmentGroup} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ApplicationAssessmentGroupItemProvider 
	 ...
	 * @generated
	 */
	public ApplicationAssessmentGroupItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns ApplicationAssessmentGroup.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ApplicationAssessmentGroup"));
	}
	...
	public String getText(Object object) {
		String label = ((ApplicationAssessmentGroup)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ApplicationAssessmentGroup_type") :
			getString("_UI_ApplicationAssessmentGroup_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ApplicationAssessmentGroup.class)) {
			case AssessmentPackage.APPLICATION_ASSESSMENT_GROUP__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case AssessmentPackage.APPLICATION_ASSESSMENT_GROUP__MEMBERS:
