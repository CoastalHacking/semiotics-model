...
/**
 * This is the item provider adapter for a {@link us.coastalhacking.semiotics.model.assessment.NetworkEgress} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NetworkEgressItemProvider 
	 ...
	 * @generated
	 */
	public NetworkEgressItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns NetworkEgress.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/NetworkEgress"));
	}
	...
	public String getText(Object object) {
		String label = ((NetworkEgress)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_NetworkEgress_type") :
			getString("_UI_NetworkEgress_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(NetworkEgress.class)) {
