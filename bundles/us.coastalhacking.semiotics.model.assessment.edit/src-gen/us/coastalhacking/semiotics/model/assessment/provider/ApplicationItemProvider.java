...
/**
 * This is the item provider adapter for a {@link us.coastalhacking.semiotics.model.assessment.Application} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ApplicationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AssessmentPackage.Literals.APPLICATION__APPLICATION_GROUP,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AssessmentPackage.Literals.APPLICATION__FLOW_GROUPS);
			childrenFeatures.add(AssessmentPackage.Literals.APPLICATION__CONTROL_GROUPS);
			childrenFeatures.add(AssessmentPackage.Literals.APPLICATION__DATA_GROUPS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AssessmentPackage.Literals.APPLICATION__FLOW_GROUPS,
				 AssessmentFactory.eINSTANCE.createFlowGroup()));

		newChildDescriptors.add
			(createChildParameter
				(AssessmentPackage.Literals.APPLICATION__CONTROL_GROUPS,
				 AssessmentFactory.eINSTANCE.createControlGroup()));

		newChildDescriptors.add
			(createChildParameter
				(AssessmentPackage.Literals.APPLICATION__DATA_GROUPS,
				 AssessmentFactory.eINSTANCE.createDataGroup()));
	}
