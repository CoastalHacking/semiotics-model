...
/**
 * This is the item provider adapter for a {@link us.coastalhacking.semiotics.model.assessment.Flow} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FlowItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AssessmentPackage.Literals.TRACEABLE__REVIEWERS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AssessmentPackage.Literals.FLOW__FLOW_FROM,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AssessmentPackage.Literals.FLOW__FLOW_TO);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AssessmentPackage.Literals.FLOW__FLOW_TO,
				 AssessmentFactory.eINSTANCE.createFlow()));
		...
		newChildDescriptors.add
			(createChildParameter
				(AssessmentPackage.Literals.FLOW__FLOW_TO,
				 AssessmentFactory.eINSTANCE.createFlowSink()));
		...
		newChildDescriptors.add
			(createChildParameter
				(AssessmentPackage.Literals.FLOW__FLOW_TO,
				 AssessmentFactory.eINSTANCE.createDataFlowSink()));
		...
		newChildDescriptors.add
			(createChildParameter
				(AssessmentPackage.Literals.FLOW__FLOW_TO,
				 AssessmentFactory.eINSTANCE.createControlFlowSink()));
	}
