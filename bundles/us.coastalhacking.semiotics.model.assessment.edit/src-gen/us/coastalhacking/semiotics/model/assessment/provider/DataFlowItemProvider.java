...
/**
 * This is the item provider adapter for a {@link us.coastalhacking.semiotics.model.assessment.DataFlow} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addSourceTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataFlow_sourceType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataFlow_sourceType_feature", "_UI_DataFlow_type"),
				 AssessmentPackage.Literals.DATA_FLOW__SOURCE_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
