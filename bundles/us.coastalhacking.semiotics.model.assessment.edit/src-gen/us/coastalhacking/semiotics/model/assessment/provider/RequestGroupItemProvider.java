...
/**
 * This is the item provider adapter for a {@link us.coastalhacking.semiotics.model.assessment.RequestGroup} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RequestGroupItemProvider 
	 ...
	 * @generated
	 */
	public RequestGroupItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RequestGroup"));
	}
	...
	public String getText(Object object) {
		String label = ((RequestGroup)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_RequestGroup_type") :
			getString("_UI_RequestGroup_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(RequestGroup.class)) {
