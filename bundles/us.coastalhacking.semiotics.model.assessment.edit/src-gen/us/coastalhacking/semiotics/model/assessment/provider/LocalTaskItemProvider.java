...
/**
 * This is the item provider adapter for a {@link us.coastalhacking.semiotics.model.assessment.LocalTask} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LocalTaskItemProvider 
	 ...
	 * @generated
	 */
	public LocalTaskItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addTaskStatusPropertyDescriptor(object);
		}
	...
	protected void addExamineesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Taskable_examinees_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Taskable_examinees_feature", "_UI_Taskable_type"),
				 AssessmentPackage.Literals.TASKABLE__EXAMINEES,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Task Status feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addTaskStatusPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Task_taskStatus_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Task_taskStatus_feature", "_UI_Task_type"),
				 AssessmentPackage.Literals.TASK__TASK_STATUS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/LocalTask"));
	}
	...
	public String getText(Object object) {
		String label = ((LocalTask)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_LocalTask_type") :
			getString("_UI_LocalTask_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(LocalTask.class)) {
